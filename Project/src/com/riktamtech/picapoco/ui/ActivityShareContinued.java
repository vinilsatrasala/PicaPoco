...
public class ActivityShareContinued extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_share_cont);
	...
	public void onClick(View v) {
		...
		case R.id.AcceptButton:
			startActivity(new Intent(ActivityShareContinued.this,
